...
export interface VVSVaultInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "calculateHarvestVVSRewards",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "calculateTotalPendingVVSRewards",
    values?: undefined
  ): string;
...
export type SetPerformanceFeeEvent = TypedEvent<
  [BigNumber],
  SetPerformanceFeeEventObject
>;

export type SetPerformanceFeeEventFilter =
  TypedEventFilter<SetPerformanceFeeEvent>;
...
export type SetWithdrawFeePeriodEvent = TypedEvent<
  [BigNumber],
  SetWithdrawFeePeriodEventObject
>;

export type SetWithdrawFeePeriodEventFilter =
  TypedEventFilter<SetWithdrawFeePeriodEvent>;
...
export interface VVSVault extends BaseContract {
  ...
  filters: {
    ...
    ): SetWithdrawFeePeriodEventFilter;
    SetWithdrawFeePeriod(
      withdrawFeePeriod?: null
    ): SetWithdrawFeePeriodEventFilter;

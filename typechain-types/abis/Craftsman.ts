...
export interface CraftsmanInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "updateStakingRatio",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "vvsStakingRatio",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type UpdatedVVSStakingRatioEvent = TypedEvent<
  [BigNumber],
  UpdatedVVSStakingRatioEventObject
>;

export type UpdatedVVSStakingRatioEventFilter =
  TypedEventFilter<UpdatedVVSStakingRatioEvent>;
...
export interface Craftsman extends BaseContract {
  ...
  filters: {
    ...
    "UpdatedVVSStakingRatio(uint256)"(
      newRatio?: null
    ): UpdatedVVSStakingRatioEventFilter;
